...
A complete reference for Rag's RESTful API. Before proceeding, please ensure you [have your Rag API key ready for authentication](../guides/models/llm_api_key_setup.md).
...
- `"pagerank"`: (*Body parameter*), `int`  
  refer to [Set page rank](https://Rag.io/docs/dev/set_page_rank)
  - Default: `0`
  - Minimum: `0`
  - Maximum: `100`
...
- `"parser_config"`: (*Body parameter*), `object`  
  ...
  - If `"chunk_method"` is `"naive"`, the `"parser_config"` object contains the following attributes:
    ...
    - `"layout_recognize"`: `string`
      - Defaults to `DeepDOC`
    - `"tag_kb_ids"`: `array<string>` refer to [Use tag set](https://Rag.io/docs/dev/use_tag_sets)
...
{
    "code": 101,
    "message": "Dataset name 'Rag example' already exists"
}
```
...
curl --request POST \
     ...
     --data '
     {
          "question": "What is advantage of Rag?",
...
```json
{
    ...
    "data": {
        "chunks": [
            {
                "content": "Rag content",
                "content_ltks": "Rag content",
                "document_id": "5c5999ec7be811ef9cab0242ac120005",
                "document_keyword": "1.txt",
                "highlight": "<em>Rag</em> content",
...
- `"prompt"`: (*Body parameter*), `object`  
  ...
  - `"similarity_threshold"`: `float` Rag employs either a combination of weighted keyword similarity and weighted vector cosine similarity, or a combination of weighted keyword similarity and weighted reranking score during retrieval. This argument sets the threshold for similarities between the user query and chunks. If a similarity score falls below this threshold, the corresponding chunk will be excluded from the results. The default value is `0.2`.
