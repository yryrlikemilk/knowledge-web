...
export default {
  ...
  rm_chunk: (knowledgeId: string, document_id: string) =>
    `${api_rag_host}/chunk/delete/${knowledgeId}/${document_id}`,
  ...
  check_for_file_updates: (knowledgeId: string) =>
    `${api_rag_host}/aiGeneration/checkForFileUpdates?kbId=${knowledgeId}`,
  ...
  get_ai_question_count_by_doc_ids: `${api_rag_host}/aiGeneration/getAiQuestionCountByDocIds`,
  other_doc_generate_ai_question: `${api_rag_host}/aiGeneration/otherDocGenerateAiQuestion`,
  ...
  retrieval_question_category: `${api_rag_host}/retrievalQuestion/questionCategory`,
  all_questions: `${api_rag_host}/retrievalQuestion/allQuestions`,
  ...
  get_run_status: (knowledgeId: string) =>
    `${api_rag_host}/dataset/getRunStatus?kbId=${knowledgeId}`,
  ...
  setConversation: `${api_rag_host}/conversation/set`,
