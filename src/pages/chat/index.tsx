...
const Chat = ({ isShared }: { isShared: boolean }) => {
    ...
    <Flex className={styles.chatWrapper}>
      <Flex className={styles.chatAppWrapper}>
            ...
            <Flex flex={1} vertical className={styles.chatAppLeft}>
              <Button
                ...
                style={{
                  borderRadius: '60px',
                  background:
                    'linear-gradient(80deg, #55C9FF 0%, #306EFD 100%)',
                  width: '216px',
                  height: 40,
                  fontSize: 16,
                  lineHeight: 20,
              ...
              >
                ...
                >
                  ...
                  <g clipPath="url(#master_svg0_76_03204)">
                    <g>
                      <path
                        d="M16.875,8.75L10,8.75L10,1.875C10,1.525,9.725,1.25,9.375,1.25C9.025,1.25,8.75,1.525,8.75,1.875L8.75,8.75L1.875,8.75C1.525,8.75,1.25,9.025,1.25,9.375C1.25,9.725,1.525,10,1.875,10L8.75,10L8.75,16.875C8.75,17.225,9.025,17.5,9.375,17.5C9.725,17.5,10,17.225,10,16.875L10,10L16.875,10C17.225,10,17.5,9.725,17.5,9.375C17.5,9.025,17.225,8.75,16.875,8.75Z"
                        fill="#FFFFFF"
                        fillOpacity="1"
                        style={{ mixBlendMode: 'normal' }}
                      />
        ...
        <Flex
          ...
          style={isShared ? { height: 'calc(100vh - 80px)' } : {}}
        >
